...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    private void setValuesFromXml(AttributeSet attrs) {
        ...
        String units = getAttributeStringValue(attrs, APPLICATIONNS, "units", "s");
    ...
    protected void updateView(View view) {
        ...
        try {
            ...
            if(mCurrentValue==0)mStatusText.setText("Sin limite");
            else mStatusText.setText(String.valueOf(mCurrentValue));
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        if(newValue==0)mStatusText.setText("Sin limite");
        else mStatusText.setText(String.valueOf(newValue));
        persistInt(newValue);
